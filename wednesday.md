...
| :---------- | ---: | ---------------: | -----------------: | ---------: | ---------: | ----------------: | ------------: | ------------: | ----------: |
| High        | 2500 |           10.274 |            566.923 |     11.156 |      6.040 |             0.447 |         0.692 |         0.272 |    5773.240 |
| Low         | 2704 |           10.495 |            501.543 |      9.229 |      4.611 |             0.435 |         0.678 |         0.294 |     889.492 |
...
| :---------- | ---: | --------------: | ----------------: | --------: | --------: | ---------------: | -----------: | -----------: | ---------: |
| High        | 2500 |           2.103 |           484.257 |    11.130 |     8.676 |            0.120 |        0.191 |        0.147 |  17067.566 |
| Low         | 2704 |           2.117 |           385.096 |     8.772 |     7.580 |            0.114 |        0.189 |        0.159 |    253.212 |
...
![](wednesday_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
...
![](wednesday_files/figure-gfm/unnamed-chunk-6-3.png)<!-- -->
...
![](wednesday_files/figure-gfm/unnamed-chunk-6-4.png)<!-- -->
...
![](wednesday_files/figure-gfm/unnamed-chunk-6-5.png)<!-- -->
...
![](wednesday_files/figure-gfm/unnamed-chunk-6-6.png)<!-- -->
...
rate was 38.7%. Logistic Regression tended to perform very weakly to the
other model. With a misclassification rate of 63.0210668%, we would be
